...
-- Settings (you should already have this)
local Settings = {
...
-- Locals (you should already have this)
local Space = game:GetService("Workspace")
local Player = game:GetService("Players").LocalPlayer
local Camera = Space.CurrentCamera
local RunService = game:GetService("RunService")

-- Function to create a line (you should already have this)
...
-- Function to update visibility of ESP elements (you should already have this)
...
-- Function to handle ESP box drawing for each player (you should already have this)
local function DrawESP(plr)
    repeat wait() until plr.Character and plr.Character:FindFirstChild("Humanoid") ~= nil
    local Library = {
    ...
    -- Create a part for position calculation (you should already have this)
        ...
        c = RunService.RenderStepped:Connect(function()
            if plr.Character and plr.Character:FindFirstChild("Humanoid") and plr.Character:FindFirstChild("HumanoidRootPart") then
                ...
                if vis then
                    ...
                    Library.TL1.To = Vector2.new(TL.X + SizeX, TL.Y)
                    Library.TL2.From = Vector2.new(TL.X, TL.Y)
                    Library.TL2.To = Vector2.new(TL.X, TL.Y + SizeY)

                    Library.TR1.From = Vector2.new(TR.X, TR.Y)
                    Library.TR1.To = Vector2.new(TR.X - SizeX, TR.Y)
                    Library.TR2.From = Vector2.new(TR.X, TR.Y)
                    Library.TR2.To = Vector2.new(TR.X, TR.Y + SizeY)

                    Library.BL1.From = Vector2.new(BL.X, BL.Y)
                    Library.BL1.To = Vector2.new(BL.X + SizeX, BL.Y)
                    Library.BL2.From = Vector2.new(BL.X, BL.Y)
                    Library.BL2.To = Vector2.new(BL.X, BL.Y - SizeY)

                    Library.BR1.From = Vector2.new(BR.X, BR.Y)
                    Library.BR1.To = Vector2.new(BR.X - SizeX, BR.Y)
                    Library.BR2.From = Vector2.new(BR.X, BR.Y)
                    Library.BR2.To = Vector2.new(BR.X, BR.Y - SizeY)

                    Vis(Library, true) -- Show ESP

                    -- Autothickness adjustment
                    ...
                    Vis(Library, false) -- Hide ESP if not visible
                end
            else
                Vis(Library, false)
            end
